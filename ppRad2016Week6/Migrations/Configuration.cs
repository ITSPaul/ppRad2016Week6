namespace ppRad2016Week6.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ppRad2016Week6.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(ppRad2016Week6.Models.ApplicationDbContext context)
        {
            var manager =
